# Claw Cubed: The AWS-Native Tiny Agent

## What It Is

**Claw Cubed** is an improved, AWS-powered variant of PicoClaw. It keeps the same lightweight design but is built for the cloud: S3 for memory, AWS MCP for tools, and a deployment model that scales.

---

## Claw Cubed vs PicoClaw
...
**Small agents, big reach.** PicoClaw proved a tiny agent can be capable. Claw Cubed pushes that further:
...
**Claw Cubed = PicoClaw + S3 memory + AWS MCP by default. Same agent, AWS-native and scalable.**
