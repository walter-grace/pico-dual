...
import (
	...
	"github.com/walter-grace/pico-combined/pkg/agentflare"
	cf "github.com/walter-grace/pico-combined/pkg/cloudflare"
	"github.com/walter-grace/pico-combined/pkg/llm"
	"github.com/walter-grace/pico-combined/pkg/mcpclient"
	"github.com/walter-grace/pico-combined/pkg/storage"
	"github.com/walter-grace/pico-combined/pkg/transcribe"
)
...
func New(cfg Config) (*Bot, error) {
	...
	ag := agentflare.New(agentflare.Config{
		LLM:       llmClient,
		MCP:       mcp,
		R2:        r2,
		CF:        cfClient,
