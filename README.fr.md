...
wget https://github.com/walter-grace/pico-combined/releases/download/v0.1.1/picoclaw-linux-arm64
...
Téléchargez le binaire pour votre plateforme depuis la page des [releases](https://github.com/walter-grace/pico-combined/releases).

### Installer depuis les sources (dernières fonctionnalités, recommandé pour le développement)

```bash
git clone https://github.com/walter-grace/pico-combined.git
